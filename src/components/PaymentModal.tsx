    ...
    <div className="absolute w-full h-full top-0 left-0 grid z-30">
      ...
      <div className="relative w-[35%] p-6 bg-white shadow-xl rounded-lg overflow-y-visible m-auto">
          <button onClick={()=>{hidePaymentModalBus()}} className="w-fit h-fit absolute right-1 top-1">
            <img src="/src/assets/exitIcon.png" alt="Exit icon" className="w-5 aspect-square"/>
          </button>
        <div className="grid grid-cols-7">
          ...
          <div className="col-start-4 col-span-4 flex justify-end items-end gap-x-5">
            <button onClick={()=>{handleDeleteButton()}}><img src="/src/assets/binIcon.png" alt="Bin icon" className="w-6 h-6 hover:scale-110 transition duration-300"/></button>
